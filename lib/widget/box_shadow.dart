...
class BoxShadows extends painting.BoxShadow {
  const BoxShadows({
  ...
  @override
  BoxShadows scale(double factor) {
    return BoxShadows(
      color: color,
  ...
  static BoxShadows? lerp(BoxShadows? a, BoxShadows? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    if (a == null) {
  ...
  ///
  /// {@macro dart.ui.shadow.lerp}
  static List<BoxShadows>? lerpList(
    List<BoxShadows>? a,
    List<BoxShadows>? b,
    double t,
  ) {
    ...
    return <BoxShadows>[
      for (int i = 0; i < commonLength; i += 1) BoxShadows.lerp(a[i], b[i], t)!,
