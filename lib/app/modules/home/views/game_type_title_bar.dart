                      ...
                      children: [
                        CupertinoButton(
                          ...
                          child: Obx(() {
                            ...
                            String icon = childTabSelectIndexRx.value == 1 ? "game_type_hot_ok" : "game_type_hot_no";
                            return Container(
                                alignment: Alignment.center,
                                child: Image.asset("assets/images/$icon.webp", width: 60.w));
                          }
                          ),
                        ),
                        CupertinoButton(
