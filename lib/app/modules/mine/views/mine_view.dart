            ...
            children: [
              Container(
                ...
                child: Text("Minha conta", style: TextStyle(
                    color: Colors.white, fontSize: 32.w, fontWeight: FontWeight.bold)),
              ),
              Container(
                  height: 360.w,
                  width: 705.w,
                    ...
                    children: [
                            ...
                            Positioned(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text("R\$ 0.00", style: TextStyle(color: Colors.white,
                                          fontSize: 42.w,
                                          fontWeight: FontWeight.bold)),
                                      SizedBox(width: 10.w),
                                      Image.asset(
                                          "assets/images/i-refresh-money.webp", width: 49.w),
                                    ],
                                  )
                                ],
                              ),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text('Benefícios', style: TextStyle(color: Colors.white, fontSize: 24
                                .w)),
                            SizedBox(width: 10.w),
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(' Recompensa total de check-in',
                            style: TextStyle(color: Colors.white, fontSize: 26.w)),
                        RichText(text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: ' R\$ 0.42',
                                style: TextStyle(color: Color(0xff0ED1F4),
                                    fontSize: 28.w,
                                    fontWeight: FontWeight.bold),
                              )
                            ]
                    ...
                    children: [
                      ...
                      CupertinoButton(
                          ...
                          child: SizedBox(
                            ...
                            child: Row(
                              children: [
                                Image(image: AssetImage("assets/images/i-gift-record.webp"),
                                    width: 40.w),
                                SizedBox(width: 26.w),
                                Text('Histórico de Recompensas', style: TextStyle(
                                    color: Colors.white, fontSize: 28.w)),
